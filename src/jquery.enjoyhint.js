            ...
            init: function (options) {
                ...
                return this.each(function () {
                    ...
                    that.renderLabelWithShape = function (data) {
                        ...
                        var buttonsSpaceGap = 25;
    
                        function twoBtnCntrPosCalc(){
                            return ((window.innerWidth)/2) - (((that.$next_btn.width() * 2) + buttonsSpaceGap)* .58);
                        }
                        function oneBtnCntrPosCalc(){
                            return ((window.innerWidth)/2) - that.$next_btn.width() * .50;
                        }
    
                        var nextBtnStartPos = that.$skip_btn.hasClass(that.cl.hide) ? oneBtnCntrPosCalc() : twoBtnCntrPosCalc();
    
                        //var left_skip = label_x + that.$next_btn.width() + 10; //Left align calculation.
                        var left_skip = nextBtnStartPos + that.$next_btn.width() + 10;
                        ...
                        that.$next_btn.css({
                            //left: label_x, //Left align position.
                            left: nextBtnStartPos,
                            top: label_y + label_height + 20
                        });
    
    
                        that.$skip_btn.css({
                            left: left_skip + buttonsSpaceGap,
                            top: label_y + label_height + 20
                        });
